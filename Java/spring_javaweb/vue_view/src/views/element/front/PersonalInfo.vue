    ...
    <el-container>
      ...
      <el-container>
        <el-aside width="300px;">
          ...
          <el-form :model="userInfo" ref="userForm" label-width="80px" style="margin-top: 250px; padding-right: 10px;">
           <el-form-item label="用户昵称">
              <el-input v-model="userInfo.name" type="text" placeholder="用户昵称" show-word-limit></el-input>
            </el-form-item>
            <el-form-item label="密码">
              <el-input v-model="userInfo.passwd" placeholder="请输入密码" show-password></el-input>
            </el-form-item>
            <el-form-item label="用户姓名">
              <el-input v-model="userInfo.name" type="text" placeholder="用户姓名" show-word-limit></el-input>
            </el-form-item>
            <el-form-item label="邮箱">
              <el-input v-model="userInfo.email" placeholder="邮箱"></el-input>
            </el-form-item>
            <el-form-item label="手机号码">
              <el-input v-model="userInfo.phoneNumber" type="text" placeholder="手机号码" maxlength="20" show-word-limit></el-input>
            </el-form-item>
          </el-form>
  ...
  methods: {
    ...
    handleAvatarSuccess(res) {
        ...
        if(res.code == "200") {
          ...
          this.$forceUpdate()
          this.userInfo.avatar = this.circleUrl
          this.save()
    ...
    save() {
      this.$http.put("/user/updateInfo", this.userInfo).then(res => {
        if (res.data.code == '200') {
    ...
    getUserInfo() {
      this.$http.get("/user/getByID?id="+this.user.id).then(res => {
        if (res.data.code == '200') {
            this.userInfo = res.data.data
            console.log("img: " + this.userInfo.avatar )
