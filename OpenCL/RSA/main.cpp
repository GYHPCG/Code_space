...
int main(int argc, const char * argv[])
{
    ...
    cl_result = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, sizeof(bignum), &result, &status);
